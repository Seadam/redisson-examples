...
public class MapCacheExamples {
    ...
    public static void main(String[] args) {
        ...
        // with ttl = 10 seconds
        Integer prevValue = mapCache.put("1", 10, 10, TimeUnit.MINUTES);
        // with ttl = 15 seconds and maxIdleTime = 5 seconds
        Integer prevValue2 = mapCache.put("2", 20, 15, TimeUnit.MINUTES, 5, TimeUnit.MINUTES);
        // store value permanently 
        Integer prevValue3 = mapCache.put("3", 30);

        // with ttl = 30 seconds
        Integer currValue = mapCache.putIfAbsent("4", 40, 30, TimeUnit.MINUTES);
        // with ttl = 40 seconds and maxIdleTime = 10 seconds
        Integer currValue2 = mapCache.putIfAbsent("5", 50, 40, TimeUnit.MINUTES, 10, TimeUnit.MINUTES);
        ...
        // with ttl = 20 seconds
        boolean isNewKey1 = mapCache.fastPut("7", 70, 20, TimeUnit.MINUTES);
        // with ttl = 40 seconds and maxIdleTime = 20 seconds
        boolean isNewKey2 = mapCache.fastPut("8", 80, 40, TimeUnit.MINUTES, 20, TimeUnit.MINUTES);
        // store value permanently 
